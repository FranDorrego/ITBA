...
export function FormPrestamos() {
  ...
  return (
    <>
      <form
        className={estilosDashboard.divMonto}
      ...
      >
        ...
        <span className={estilosDashboard.cuotas}>
          ...
          <input
            type="number"
            placeholder="Ingrese monto a solicitar"
            id="monto"
            {...register("monto", {
              required: true,
            })}
          ...
          {errors.monto?.type === "required" && (
            <LabelErrorLogin>Monto requerido</LabelErrorLogin>
          )}
        </span>
        ...
        <span className={estilosDashboard.cuotas}>
          ...
          {errors.cuotas?.type === "required" && (
            <LabelErrorLogin>Selecciona la cantidad de cuotas</LabelErrorLogin>
          )}
        </span>
        <button id="botonSimular" type="submit">
          Simular
        </button>
      </form>
      <SimuladorPrestamo
        interesesAPagar={interesesAPagar}
        cuotasDe={cuotasDe}
