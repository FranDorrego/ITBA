...
export function TrajetasSaludo() {
  ...
  return (
    <div className={estilosDashboard.tarjetasDashboard}>
      <span
        className={`${estilosDashboard.tarjetas} ${estilosDashboard.saldo}`}
      >
      ...
      <span
        className={`${estilosDashboard.tarjetas} ${estilosDashboard.ingresoTarjeta}`}
      >
        <h1>Ingresos</h1>
      ...
      <span
        className={`${estilosDashboard.tarjetas} ${estilosDashboard.retiroTarjeta}`}
      >
        <h1>Retiros</h1>
