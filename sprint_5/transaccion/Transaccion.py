...
class Transaccion():
    ...
    def __init__(self , estado : ["ACEPTADA","RECHAZADA"], tipo: TIPO_OPERACIONES , permitidoActualParaTransccion : int | float, monto: int | float, fecha: str, numero: int, cuentaNumero: int):
        f"""
