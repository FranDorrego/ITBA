...
export function validarDatosLogin(){
    ...
    if(usuario.value.length < 4){
        return alert("Usuario no valido, debe tener mas de 4 caracteres")
    }
    else if(dni.value.length < 4){
        return alert("DNI no valido")
    }
    else if(password.value.length < 8){
        return alert("Contraseña no valida, debe tener mas de 8 caracteres")
    } else {
        return alert("Datos validos, iniciando sesion")
    }
}

export function validarDatosPassword(){
...
export function validarDatosRegistro(){
...
export function Boton({value, id, validarDatos}){  
    return(
