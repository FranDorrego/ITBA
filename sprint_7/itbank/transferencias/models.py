...
class AuditoriaCuenta(models.Model):
    ...
    old_balance = models.TextField()  # This field type is a guess.
    new_balance = models.TextField()  # This field type is a guess.
    old_iban = models.TextField()  # This field type is a guess.
    new_iban = models.TextField()  # This field type is a guess.
    old_tipe = models.TextField()  # This field type is a guess.
    new_tipe = models.TextField()  # This field type is a guess.
...
class ClientesDireccion(models.Model):
    ...
    id_dirrecion = models.ForeignKey('Direccion', models.DO_NOTHING, db_column='id_dirrecion', blank=True, null=True)
...
class Tarjeta(models.Model):
    numero = models.CharField(max_length=150, unique=True, blank=True, null=True)
