...
export function GeneralCambioDivisa(){
    ...
    useEffect(()=>{
        ...
        fetch('https://v6.exchangerate-api.com/v6/b33857f0c7a369ed9a5061f0/latest/USD')
        .then(res => res.json())
        .then(data => 
            {
    ...
    useEffect(() =>{
        if(fromCurrency != null && toCurrency != null){
            fetch(`https://v6.exchangerate-api.com/v6/b33857f0c7a369ed9a5061f0/latest/${fromCurrency}`)
            .then(res => res.json())
    ...
    return(
        <div className={estilosPlantilla.general}>
            ...
            <ContenedorPrincipal>
                ...
                <ContenedorMonto textPrincipal="Monto de origen" placeholder="Origen" 
                ...
                />
                <SpanCambioDivisas texto={`1 ${fromCurrency} = ${exchangeRate} ${toCurrency}`}/>

                <ContenedorMonto textPrincipal="Monto de convertido" placeholder="Convertido" 
                currencyOptions={currencyOptions}
