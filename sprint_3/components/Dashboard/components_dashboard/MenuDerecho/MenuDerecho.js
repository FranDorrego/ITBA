    ...
    return(
        <div className={estilosPlantilla.menuDerecho}>
            ...
            <ElementosMenuDercho>
                ...
                <BotonDerecho text="Prestamos" imagen='/circle-arrow-down-deposito.svg' link="/prestamos"/>
                <BotonDerecho text="Transferencias" imagen='/transferencias.svg' link="/transferencias"/>
                <Tarjeta />
            </ElementosMenuDercho>
        </div>
