  ...
  return (
    ...
    >
      ...
      {errors.importe?.type === "required" && (
        <LabelErrorLogin>Importe requerido</LabelErrorLogin>
      )}
...
const RadioDiv = ({ children }) => {
  return (
    <div className={estilosDashboard.transFormularioRadioDiv}>{children}</div>
  );
};
  ...
  return (
    <div className={estilosDashboard.transFormulario}>
      ...
      <h1 className={estilosDashboard.AchicaLetra}>
        *El importe mínimo a transferir es de $ 1 y el máximo es de de dos
